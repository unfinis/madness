...
#### Enhanced Method (Assets Manager) ⭐ NEW!
1. Click "📦 Assets Manager" button
2. Click "➕ Create Asset"
3. Select asset type from dropdown
4. Fill in name and confidence level
5. **Use type-specific property editors** with pre-configured fields:
   - Network Segments: CIDR, VLAN, NAC config, access levels
   - Hosts: IP, hostname, MAC address, OS, open ports
   - Services: host, port, protocol, version, URL, auth
   - Credentials: username, password, type, domain, validity
   - Web Apps: URL, technology stack, CMS detection
6. Click "Save Asset"
7. See your asset in the beautiful grid view!
8. **Edit or delete** assets anytime with a single click
