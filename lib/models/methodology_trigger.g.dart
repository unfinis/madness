...
_TriggerConditionGroup _$TriggerConditionGroupFromJson(
...
Map<String, dynamic> _$TriggerConditionGroupToJson(
  _TriggerConditionGroup instance,
) => <String, dynamic>{
...
_MethodologyTrigger _$MethodologyTriggerFromJson(Map<String, dynamic> json) =>
    _MethodologyTrigger(
...
Map<String, dynamic> _$MethodologyTriggerToJson(_MethodologyTrigger instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_TriggeredMethodology _$TriggeredMethodologyFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$TriggeredMethodologyToJson(
  _TriggeredMethodology instance,
) => <String, dynamic>{
  'id': instance.id,
  'methodologyId': instance.methodologyId,
...
_BatchedTrigger _$BatchedTriggerFromJson(Map<String, dynamic> json) =>
    _BatchedTrigger(
      id: json['id'] as String,
      methodologyId: json['methodologyId'] as String,
...
Map<String, dynamic> _$BatchedTriggerToJson(_BatchedTrigger instance) =>
    <String, dynamic>{
      'id': instance.id,
      'methodologyId': instance.methodologyId,
